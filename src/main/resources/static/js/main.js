...
function viewUserTopics() {
    var element = '<button type="button" class="btn btn-primary rounded-0 p-2 container-fluid chat-button" data-bs-toggle="modal" data-bs-target="#new-chat-modal">' +
                        '<div class="row align-items-center">' +
                            '<div class="col-1">' +
                                ...
                                '</svg>' +
                            '</div>' +
                            '<div class="text-start col ">Create new group chat</div>' +
                        '</div>' +
                    '</button>';
